...
import '../models/listellipsethirtynine4_item_model.dart';
import 'package:flutter/material.dart';
import 'package:sixsensemobility/core/app_export.dart';

// ignore: must_be_immutable
class Listellipsethirtynine4ItemWidget extends StatelessWidget {
  Listellipsethirtynine4ItemWidget(this.listellipsethirtynine4ItemModelObj);

  Listellipsethirtynine4ItemModel listellipsethirtynine4ItemModelObj;

  var controller = Get.find<GpsTravelHistoryPastTripDetailsOneController>();
