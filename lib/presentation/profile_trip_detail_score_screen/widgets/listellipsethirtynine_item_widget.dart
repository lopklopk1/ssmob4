...
import '../models/listellipsethirtynine_item_model.dart';
import 'package:flutter/material.dart';
import 'package:sixsensemobility/core/app_export.dart';

// ignore: must_be_immutable
class ListellipsethirtynineItemWidget extends StatelessWidget {
  ListellipsethirtynineItemWidget(this.listellipsethirtynineItemModelObj);

  ListellipsethirtynineItemModel listellipsethirtynineItemModelObj;

  var controller = Get.find<ProfileTripDetailScoreController>();
