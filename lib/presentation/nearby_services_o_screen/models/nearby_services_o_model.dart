import 'package:get/get.dart';import 'package:sixsensemobility/data/models/selectionPopupModel/selection_popup_model.dart';import 'listlanguage_item_model.dart';class NearbyServicesOModel {RxList<SelectionPopupModel> dropdownItemList = [SelectionPopupModel(id:1,title:"test",isSelected:true,),SelectionPopupModel(id:2,title:"test1",),SelectionPopupModel(id:3,title:"test2",)].obs;
