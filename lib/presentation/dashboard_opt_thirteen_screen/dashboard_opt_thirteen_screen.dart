import '../dashboard_opt_thirteen_screen/widgets/listtitle_two1_item_widget.dart';
...
class DashboardOptThirteenScreen
    extends GetWidget<DashboardOptThirteenController> {
  @override
                                    ...
                                    child: Obx(
                                      () => ListView.builder(
                                        ...
                                        itemCount: controller
                                            .dashboardOptThirteenModelObj
                                            .value
                                            .listtitleTwo1ItemList
                                            .length,
                                        itemBuilder: (context, index) {
                                          ListtitleTwo1ItemModel model =
                                              controller
                                                  .dashboardOptThirteenModelObj
                                                  .value
                                                  .listtitleTwo1ItemList[index];
                                          return ListtitleTwo1ItemWidget(
                                            model,
                                          );
                                        },
                                      ),
