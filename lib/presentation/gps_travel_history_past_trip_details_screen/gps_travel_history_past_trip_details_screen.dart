import '../gps_travel_history_past_trip_details_screen/widgets/listellipsethirtynine3_item_widget.dart';
                                              ...
                                              child: Obx(
                                                () => ListView.builder(
                                                  ...
                                                  itemCount: controller
                                                      .gpsTravelHistoryPastTripDetailsModelObj
                                                      .value
                                                      .listellipsethirtynine3ItemList
                                                      .length,
                                                  itemBuilder:
                                                      (context, index) {
                                                    Listellipsethirtynine3ItemModel
                                                        model = controller
                                                            .gpsTravelHistoryPastTripDetailsModelObj
                                                            .value
                                                            .listellipsethirtynine3ItemList[index];
                                                    return Listellipsethirtynine3ItemWidget(
                                                      model,
                                                    );
                                                  },
                                                ),
